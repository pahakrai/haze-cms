module.exports = {
  items: [
    // System Admin List
    {
      _id: '5e8414da9b13b76e19fb4061',
      to: '/users/system-admin',
      auth: ['User:SystemAdmin:View'],
      icon: 'MdAccountBox',
      localeId: 'nav.system_admin',
      component: 'UserSystemAdminPage',
      idx: 1,
      priority: 1
    },
    // System Admin Edit
    {
      _id: '5e8414c5026b90d598ed2052',
      to: '/users/system-admin/:userId',
      auth: ['User:SystemAdmin:Edit'],
      hideMenu: true,
