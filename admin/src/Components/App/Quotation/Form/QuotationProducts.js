...
import QuotationProductInput from './QuotationProductInput'
import { ProductItem, ProductActions, Hr } from './QuotationProducts.styled'
...
const QuotationProductsField = ({
  ...
  const renderItem = useCallback(
    ...
    [options, editMode, intl, input, getProductText, onDelete]
  )
...
export default (props) => {
  return <Field {...props} component={QuotationProductsField} />
}
