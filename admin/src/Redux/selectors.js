...
export const notificationScheduleHydrate = createHydrate(
...
export const vehicleCapabilityHydrateAll = createHydrateAll(
  'vehicleCapability'
);
...
export const workspacePhoneRegionHydrate = createHydrate(
  'workspacePhoneRegion'
);
...
export const tagRecommendationHydrateAll = createHydrateAll(
  'tagRecommendation'
);
...
export const getFileMetas = fileMetaHydrateAll(state => state.fileMeta.results);
...
export const getSearchUsers = userHydrateAll(state => state.user.searchResults);
...
export const getWorkspace = workspaceHydrate(state => state.workspace.selected);
...
export const getFileMetaById = (state, _id) =>
  fileMetaHydrate(() => _id)(state);
export const getAllSvgFileMeta = state => {
  const fileMetas = Object.values(state.resources.fileMetas);
  const ids = fileMetas.filter(v => v.fileExtension === '.svg').map(v => v._id);
...
export const getMerchants = merchantHydrateAll(state => state.merchant.results);
...
export const getAllWorkspaceSubscriptionPlans = workspaceSubscriptionPlanHydrateAll(
...
export const getShipments = shipmentHydrateAll(state => state.shipment.results);

export const getShipmentById = (state, _id) =>
  shipmentHydrate(() => _id)(state);
...
export const getFeedbacks = feedbackHydrateAll(state => state.feedback.results);
...
export const getCategoriesForParent = (state, parent) => {
...
// reports
export const getCustomers = customerHydrateAll(state => state.customer.results);
...
export const getEmployees = employeeHydrateAll(state => state.employee.results);
...
export const getWorkspaceSubscriptionInvoices = workspaceSubscriptionInvoiceHydrateAll(
